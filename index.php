        ...
        <div class="mainslider glide">
            <div class="glide__track" data-glide-el="track">
                <ul class="glide__slides">
                    <li style="background-image: url('<?php echo bloginfo('template_url'); ?>/essets/img/bg_1.jpg')" class="glide__slide">
                        <div class="container">
                            <div class="row">
                    ...
                    <li style="background-image: url('<?php echo bloginfo('template_url'); ?>/essets/img/bg_2.jpg')" class="glide__slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                    ...
                    <li style="background-image: url('<?php echo bloginfo('template_url'); ?>/essets/img/bg_3.jpg')" class="glide__slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?php echo bloginfo('template_url'); ?>/essets/img/team.jpg" alt="наша команда">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="toys" id="toys">
            <div class="container">
                ...
                <div class="toys__wrapper">
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo('template_url'); ?>/essets/img/toy_1.jpg)">
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo('template_url'); ?>/essets/img/toy_2.jpg)">
                        <div class="toys__item-info">
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo('template_url'); ?>/essets/img/toy_3.jpg)">
                        <div class="toys__item-info">
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo('template_url'); ?>/essets/img/toy_4.jpg)">
                        <div class="toys__item-info">
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo('template_url'); ?>/essets/img/toy_5.jpg)">
                        <div class="toys__item-info">
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo('template_url'); ?>/essets/img/toy_6.jpg)">
                        <div class="toys__item-info">
                ...
                <div class="toys__wrapper">
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo('template_url'); ?>/essets/img/toy_7.jpg)">
                        <div class="toys__item-info">
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo('template_url'); ?>/essets/img/toy_8.jpg)">
                        <div class="toys__item-info">
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php echo bloginfo('template_url'); ?>/essets/img/about_1.jpg" alt="мир детства">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php echo bloginfo('template_url'); ?>/essets/img/about_2.jpg" alt="мир детства">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                            Главное - качество
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php echo bloginfo('template_url'); ?>/essets/img/about_3.jpg" alt="мир детства">
                    </div>
                </div>
            </div>
        </div>
